# 4.10.Integración y distribución
## 4.10. Distribución e integración de la solución
...
### 4.10.1. Distribución de la librería
...
### 4.10.2. Aplicación web como caso de uso
...
### 4.10.3. Flujo de funcionamiento de la aplicación
...
### 4.10.4. Separación entre presentación y lógica de análisis
...
### 4.10.5. Consideraciones sobre infraestructura
